    ...
    <footer className='bg-stone-900 text-stone-300'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14'>
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-10'>
          ...
          <div>
            ...
            <div className='flex items-center gap-3 mt-5'>
              ...
              <a
                href='https://www.wildberries.ru/seller/4293534'
                target='_blank'
                rel='noopener noreferrer'
                className='w-[38] h-9 rounded-full bg-stone-800 flex items-center justify-center text-stone-400 hover:bg-rose-600 hover:text-white transition-colors'
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d='M18 6v12h3c1.5 0 3-1 3-3s-1.5-3-3-3h-3m0 0h2.5c1.5 0 2.5-1 2.5-3s-1-3-2.5-3H18'
                    stroke='currentColor'
                    strokeWidth='2'
                    strokeLinecap='round'
                    strokeLinejoin='round'
        ...
        <div className='border-t border-stone-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-stone-500'>
          <span>
            © {new Date().getFullYear()} Morena Cosmetics. {t('rights')}
          </span>
