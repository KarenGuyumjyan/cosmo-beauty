...
const CATEGORIES = [
  { image: '/categories/cosmetic-sponges.png', label: { en: 'Sponges',     hy: 'Spongeնер',   ru: 'Спонжи' },   href: '/catalog?cat=cosmetic-sponges' },
  { image: '/categories/lip-pencil.jpg',       label: { en: 'Lip Pencil',  hy: 'Lip Matok',   ru: 'Карандаш' }, href: '/catalog?cat=lip-pencil' },
  ...
  { image: '/categories/lip-gloss.jpg',        label: { en: 'Lip Gloss',   hy: 'Lip Blesk',   ru: 'Блеск' },    href: '/catalog?cat=lip-gloss' },
