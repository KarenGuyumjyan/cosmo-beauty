export const generalText = [
  ...
  },
  {
    ...
    description: `9.1. Оферта вступает в силу с момента размещения на Сайте Продавца и действует до момента её отзыва Продавцом. 
  ...
  },
  {
    ...
    description: `10.1. Договор, его заключение и исполнение регулируется действующим законодательством Российской Федерации. Все вопросы, не урегулированные настоящей Офертой или урегулированные не полностью, регулируются в соответствии с материальным правом Российской Федерации. 
  ...
  },
  {
    ...
    description: `Полное наименование: ВАНОЯН НАИРА МИНАСОВНА 
      ИНН: 900107866703
      ОГРН/ОГРНИП: 324900100045192
      Контактный телефон: +7 (999) 780-41-60
      Контактный e-mail: `,
  },
]
